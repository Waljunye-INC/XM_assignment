...
type Apartment struct {
	...
	BuildingID int64       `boil:"building_id" json:"building_id" toml:"building_id" yaml:"building_id"`
	...
	SQMeters   float32     `boil:"sq_meters" json:"sq_meters" toml:"sq_meters" yaml:"sq_meters"`
...
var ApartmentTableColumns = struct {
	...
	ID:         "apartments.id",
	BuildingID: "apartments.building_id",
	Number:     "apartments.number",
	Floor:      "apartments.floor",
	SQMeters:   "apartments.sq_meters",
}
...
var ApartmentWhere = struct {
	ID         whereHelperint64
	BuildingID whereHelperint64
	Number     whereHelpernull_String
	Floor      whereHelperint
	SQMeters   whereHelperfloat32
}{
	ID:         whereHelperint64{field: "\"apartments\".\"id\""},
	BuildingID: whereHelperint64{field: "\"apartments\".\"building_id\""},
	Number:     whereHelpernull_String{field: "\"apartments\".\"number\""},
	Floor:      whereHelperint{field: "\"apartments\".\"floor\""},
	SQMeters:   whereHelperfloat32{field: "\"apartments\".\"sq_meters\""},
}
...
func (o *Apartment) GetBuilding() *Building {
	if o == nil {
		return nil
	}

	return o.R.GetBuilding()
}
...
var (
	...
	apartmentColumnsWithoutDefault = []string{"building_id", "floor", "sq_meters"}
	apartmentColumnsWithDefault    = []string{"id", "number"}
...
func (q apartmentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Apartment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for apartments")
	}
...
func (q apartmentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count apartments rows")
	}
...
func (q apartmentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if apartments exists")
	}
...
func (apartmentL) LoadBuilding(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApartment interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`buildings`),
		qm.WhereIn(`buildings.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Apartments(mods ...qm.QueryMod) apartmentQuery {
	mods = append(mods, qm.From("\"apartments\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"apartments\".*"})
	}
...
func FindApartment(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Apartment, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"apartments\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from apartments")
	}
...
func (o *Apartment) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no apartments provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"apartments\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"apartments\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into apartments")
	}
...
func (o *Apartment) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update apartments, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"apartments\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update apartments row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for apartments")
	}
...
func (q apartmentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for apartments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for apartments")
	}
...
func (o ApartmentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"apartments\" SET %s WHERE %s",
...
func (o *Apartment) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("models: no apartments provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert apartments, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(apartmentPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert apartments, could not build conflict column list")
			}

			conflict = make([]string, len(apartmentPrimaryKeyColumns))
			copy(conflict, apartmentPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"apartments\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert apartments")
	}
...
func (o *Apartment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from apartments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for apartments")
	}
...
func (q apartmentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from apartments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for apartments")
	}
...
func (o ApartmentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"apartments\" WHERE " +
...
func (o *ApartmentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"apartments\".* FROM \"apartments\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, apartmentPrimaryKeyColumns, len(*o))
...
func ApartmentExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"apartments\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if apartments exists")
	}
